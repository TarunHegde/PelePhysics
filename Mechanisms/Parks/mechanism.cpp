#include "mechanism.H"
const int rmap[NUM_REACTIONS] = {0, 1, 2, 3, 4};
...
{
  const int ns[NUM_GAS_REACTIONS] = {2, 2, 3, 4, 4};
  const int kiv[NUM_GAS_REACTIONS * 4] = {1, 3, 0, 0, 0, 4, 0, 0, 2, 3,
                                          4, 0, 1, 4, 3, 2, 2, 4, 3, 0};
  const int nuv[NUM_GAS_REACTIONS * 4] = {-1, 2, 0,  0,  -1, 2, 0,  0,  -1, 1,
                                          1,  0, -1, -1, 1,  1, -1, -1, 1,  1};
  if (i < 1) {
